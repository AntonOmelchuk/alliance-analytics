...
PVP_EVENTS = [
    {"name": "Multi Team Battle", "times": ["02:00", "10:00", "18:00"]},
    {"name": "Capture The Base", "times": ["04:00", "12:00", "20:00"]},
    {"name": "Epic Boss Challenge", "times": ["08:00", "16:00", "00:00"]},
    {"name": "Death Match", "times": ["06:00", "14:00", "22:00"]},
]
            ...
            if event_key in events_schedule:
                ...
                if diff_minutes == lead_time_min:
                    send_notification(
                        ...
                        body=f"Event starts in {lead_time_min} minutes!",
                        event_id=event_key
                    )